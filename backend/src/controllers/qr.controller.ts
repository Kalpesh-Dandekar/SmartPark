...
import { authorizeParking } from "../services/device.service.js";
...
export async function authorize(req: Request, res: Response) { res.json({ data: await authorizeParking(String(req.params.token), req.auth!.uid) }); }
