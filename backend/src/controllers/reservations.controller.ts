...
import { z } from "zod";
import { cancelReservation, checkoutReservation, confirmParkingById, createReservation, getReservationForUser, listUserReservations } from "../services/reservation.service.js";
...
export async function confirmParking(req: Request, res: Response) { res.json({ data: await confirmParkingById(String(req.params.id), req.auth!.uid) }); }
